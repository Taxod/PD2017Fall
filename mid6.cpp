...
void avecost_f(bool coverd[][MAX_CITY],const float Construct_cost[],float avecost[],int village,const int population[]);
...
//method2--------------------------------------------------------------------
    ...
    while(check(village,comparesite)){
        ...
        answer2[answer_count2] = mincostindex;
        answer_count2++;
        refreshbool(compare, coverd, mincostindex, village, comparesite);
    }
    ...
    while(1){
        ...
        answer2[answer_count2] = mincostindex2;
        answer_count2++;
    }    
//method3--------------------------------------------------------------
total_cost = 0;
    ...
    while(check(village,comparesite)){
        ...
        answer3[answer_count3] = mincostindex;
        answer_count3++;
        refreshbool(compare, coverd, mincostindex, village, comparesite);
    }
 ...
 //----------------------------------------------------------   
    ...
    for (int i = 0; i < answer_count; ++i)
    {
        score += population[answer[i]];
    }
    for (int i = 0; i < answer_count2; ++i)
    {
        score2 += population[answer2[i]];
    }
    for (int i = 0; i < answer_count3; ++i)
    {
        score3 += population[answer3[i]];
    }
    
    if (method1_ && method2_ && method3_)
    {
        ...
        {
            for (int i = 0; i < answer_count2-1; ++i)
            {
                cout << answer2[i]+1 << " ";
            }
            cout << answer2[answer_count2-1]+1;
        }else{
            for (int i = 0; i < answer_count3-1; ++i)
            {
                cout << answer3[i]+1 << " ";
            }
            cout << answer3[answer_count3-1]+1;
        }
    }else if (method1_ && method2_)
    {
        if (score > score2)
        {
            for (int i = 0; i < answer_count-1; ++i)
